...
function [watermarked_image, extracted_watermark, encrypted_image] = dwt_svd(cover_image,watermark_logo,alpha,attack,param)
...
encrypted_watermark_logo = encrypt_image(watermark_logo, 5);
encrypted_image = encrypted_watermark_logo;
[Uw, Sw, Vw] = svd(double(encrypted_watermark_logo), 'econ');
...
extracted_watermark =uint8(decrypt_image(w_hat, 5));
end
